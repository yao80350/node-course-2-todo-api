  ...
  it('should create a new todo', (done) => {
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        Todo.find({text}).then((todos) => { //Todo是todo.js内定义model('todos')
...
describe('GET /users/me', () => {
  ...
  it('should return 401 if not authenticated', (done) => {
    request(app)
      ...
      .expect(401)
      .expect((res) => {
        expect(res.body).toEqual({}); //{} can't toBe(===),using toEqual(==)
      })
      .end(done);
  });
});
...
describe('POST /users', () => {
  ...
  // unique: true 会报错所以没做，要做的话，需要自己另做 unique功能
